# from https://github.com/RLGym/rlgym-tools/blob/v2/rlgym_tools/replays/convert.py
...
from rlgym_sim.utils.common_values import ORANGE_TEAM, BLUE_TEAM
from rlgym_sim.utils.math import quat_to_rot_mtx

from replay_trainer.data.convert.utils import Car, RocketSimEngine, FixedTeamSizeMutator, KickoffMutator \
    , ball_hit_ground, aerial_inputs, ScoreboardInfo, TICKS_PER_SECOND, DOUBLEJUMP_MAX_DELAY
...
ReplayFrame.__slots__ = ["state", "actions", "update_age", "scoreboard", "episode_seconds_remaining", "next_scoring_team", "winning_team"]
