...
from replay_trainer.data.convert.utils import SharedInfoProvider, AgentID, ball_hit_ground, TICKS_PER_SECOND, GRAVITY
...
ScoreboardInfo.__slots__ = ['game_timer_seconds', 'kickoff_timer_seconds', 'blue_score', 'orange_score', 'go_to_kickoff', 'is_over']
